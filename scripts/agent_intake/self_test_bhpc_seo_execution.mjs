...
for (const test of fixture.cases || []) {
  ...
  if (typeof test.expected_page_type_recognized === 'boolean' && result.page_type_recognized !== test.expected_page_type_recognized) failures.push(`${test.name}:page_type_recognized=${result.page_type_recognized}`);
