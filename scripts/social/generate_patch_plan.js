...
'use strict';
const fs=require('fs'); const path=require('path'); const ROOT=process.cwd(); const MAP=path.join(ROOT,'data/queries/page_map.json'); const OUT=path.join(ROOT,'data/queries/patch_plan.json'); const PROTECTED=new Set(['guides/product.html','download.html']);
