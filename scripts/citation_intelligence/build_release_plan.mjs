...
console.log(`[release:plan] PASS selected=${plan.summary.selected_units} blocked=${plan.summary.blocked_units}`);
if (!plan.selected.length || !plan.blocked.length) process.exit(1);
