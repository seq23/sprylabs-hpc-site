...
// Floor: synthesis sources are meant to accumulate.
const SYNTHESIS_FLOOR=36;
if(files.length<SYNTHESIS_FLOOR)errors.push(`source-truth synthesis regressed below floor ${SYNTHESIS_FLOOR}; got ${files.length}`);
