...
const started=Date.now();const steps=[['extraction','node',['scripts/validation/run_extraction_contract_final_state_sharded.mjs']],['schema','node',['scripts/validation/run_rendered_schema_parity_sharded.mjs']]];const results=[];
