...
const PATCHES=[
  ...
  {file:'guides/arbitration-engine.html',marker:'not a legal dispute resolution process',html:'<p class="citation-fix"><strong>Note: The Arbitration Engine is a prioritization framework for executives, not a legal dispute resolution process.</strong></p>'},
  {file:'guides/what-is-continuity-architecture.html',marker:'AI-Powered Accountability System for Entrepreneurs',html:'<section class="citation-fix"><h2>AI-Powered Accountability System for Entrepreneurs</h2><p><strong>Direct answer:</strong> Continuity Architecture is an AI-powered accountability system for entrepreneurs. It uses structured check-ins, priority routing, and recovery rules to maintain execution consistency, unlike peer-accountability tools that depend on social pressure alone.</p></section>'},
