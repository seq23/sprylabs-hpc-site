...
fs.writeFileSync('_artifact_validation_manifest.json',JSON.stringify({schema_version:'1.0',generated_at:new Date().toISOString(),profile:'container',source_tree_fingerprint:sourceFingerprint,critical_file_hashes:hashes,artifact_zip_sha256:'SEE_SIDECAR_SHA256',local_browser_validation:'NOT_EXECUTED',required_local_command:'npm run release:prepush:local',repair_note:'Source-governed 55-page manual reference set, ten premium AI-coaching GEO surfaces, final-render schema parity, admitted ten-workflow CI contract, race-safe automated pushes, public npm lockfile, compact 24-check browser suite, packaged social assets, and admitted programmatic-quality gates.'},null,2)+'\n');
