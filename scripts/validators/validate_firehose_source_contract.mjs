...
for(const p of ['_citation_intelligence_contract.json','data/signals/source_health.json','data/signals/firehose_ledger.json']) if(!fs.existsSync(p)) errors.push(`missing ${p}`);
