...
import {hasBhpcInternalLinkMutation} from '../lib/bhpc_link_mutations.mjs';
...
const report = {schema_version:'1.3', validator:'bhpc-rich-new-page-contract', status:errors.length?'FAIL':'PASS', checked_count:checked.length, checked:checked.slice(0,100), errors};
