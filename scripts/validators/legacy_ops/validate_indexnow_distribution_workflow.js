...
const required = [
  ...
  'scripts/distribution/indexnow_submit.sh',
...
includes('scripts/distribution/indexnow_submit.sh', 'INDEXNOW_DRY_RUN', 'dry-run support');
includes('scripts/distribution/indexnow_submit.sh', 'reports/indexnow-submit-report.json', 'default report path');
includes('scripts/distribution/indexnow_submit.sh', 'distribution.config.json', 'config fallback');
includes('scripts/distribution/indexnow_submit.sh', 'allow_mixed', 'mixed-host support');
includes('scripts/distribution/indexnow_submit.sh', 'chunk_size', 'chunking support');

includes('scripts/distribution/deploy_distribution.sh', 'IndexNow is the guaranteed first-class lane', 'IndexNow-first contract');
includes('scripts/distribution/deploy_distribution.sh', 'GSC skipped', 'GSC optional skip messaging');
includes('scripts/distribution/deploy_distribution.sh', '|| true', 'GSC non-blocking behavior');
