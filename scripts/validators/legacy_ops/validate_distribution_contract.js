...
const req = [
  ...
  'scripts/distribution/bootstrap_distribution.sh',
  'scripts/distribution/indexnow_submit.sh',
  'scripts/distribution/gsc_submit_sitemaps.py',
  'scripts/distribution/gsc_inspect_urls.py',
  'scripts/distribution/deploy_distribution.sh',
  'scripts/distribution/distribution_common.py',
...
if (fs.existsSync(path.join(root, 'scripts/distribution', '__pycache__'))) fail('scripts/distribution/__pycache__ must not be committed');
