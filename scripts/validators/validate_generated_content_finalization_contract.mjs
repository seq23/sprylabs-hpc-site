...
mustScript('release:agent-intake', ['run_self_healing_agent_intake.mjs']);
mustScript('release:agent-intake:transaction', ['release:agent-intake:raw','release:content-finalize','authority:scale:freeze','validate:authority-scale']);
...
const report = {schema_version:'1.0', validator:'generated-content-finalization-contract', status:errors.length?'FAIL':'PASS', checked_scripts:['release:content-finalize','release:agent-intake','release:agent-intake:transaction','workflow:content-expansion','workflow:content-authority'], errors};
