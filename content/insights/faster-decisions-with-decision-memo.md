...
This guide gives you a **calm, executable** way to think about **how to make decisions faster with a decision memo** — with definitions, steps, and a small set of moves you can repeat.
