...
tags: ["scope","constraints","boundaries"]
publish_on: "2026-03-15"
---

# How to prevent work from expanding forever (scope control)
...
How to prevent work from expanding forever (scope control) is solvable when you stop relying on motivation and start using a calm operating system. This page gives you a definition, a framework, failure modes, and a tiny ‘today’ plan.
